...
- Fixes something that is not EagleKey's responsibility: Ubuntu 26.04 LTS, 24.04 LTS and 22.04 LTS default to allowing only public keys and not passwords. We have corrected that behaviour on the template, and now allows password + public keys.
